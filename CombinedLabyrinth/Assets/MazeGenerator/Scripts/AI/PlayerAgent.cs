...
namespace MazeGenerator.Scripts.AI
{
    public class PlayerAgent : Agent
    {
        ...
        public static Vector2 buttonPos { set; private get; }
        public static Vector2 exitPos { set; private get; }
        ...
        public override void OnActionReceived(ActionBuffers actionBuffers)
        {
            ...
            playerInputs.MoveInput(new Vector2(actionX, actionZ));
        }
